...
// codeToLeveler redirects OK to DEBUG level logging instead of INFO
// This is an example how you can log several gRPC code results
...
func AddLogging(logger *zap.Logger, opts []grpc.ServerOption) []grpc.ServerOption {
	...
	// Make sure that log statements internal to gRPC library are logged using the zap logger
